...
export function DashboardSkeleton() {
  return (
    <Region label={it.skeletonDashboardLabel} className={styles.dashboard}>
      ...
      <div className={styles.stack} style={{ gap: "var(--space-2)", margin: "var(--space-3) 0 var(--space-6)" }}>
      ...
      <div className={styles.stack} style={{ marginTop: "var(--space-8)" }}>
      ...
      <ol className={styles.steps}>
        {Array.from({ length: 7 }, (_, index) => (
          <li key={index} className={styles.step}>
            ...
            <Skeleton width="3.25rem" className={styles.stepLabel} />
          </li>
        ))}
      </ol>
